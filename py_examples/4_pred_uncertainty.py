...
# performDropoutPrediction('F', model, '180min', 12, retrain=False)
performDropoutPrediction('F', model, '180min', 6, retrain=False)
# mlModule.reset()
#performDropoutPrediction('G', model, '60min', 6, retrain=False)
mlModule.reset()
