...
filename = "../master-thesis-db/datasets/D/name',dataC.csv"

# List of columns on form [' 'description', 'unit']
columns = [
...
for model in modelList:
    ...
    print("model.name:{0}, deviationsList:{1}".format(model.name, deviationsList))
